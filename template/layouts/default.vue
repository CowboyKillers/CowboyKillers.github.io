      ...
      <transition name="page" mode="out-in">
       ...
       <div class="ckFoot siimple-footer siimple-footer--fluid">
           <div class="footRow siimple-grid-row">
            <div class="footLinks siimple-link siimple-grid-col siimple-grid-col--3">
            ...
            <div class="footLinks siimple-link siimple-grid-col siimple-grid-col--4">
            ...
            <div class="footCred siimple-link siimple-grid-col siimple-grid-col--5">
